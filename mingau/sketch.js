...
function setup() {
  ...
  next = false;
  oriCont = 0;
  menu = new GUI(50, 50, 200, 200, 50, "menu");
  ...
  obj = {
    ...
    origame: {
      ...
      pagUm: new GUI(
        ...
        width / 2,
        (imagem.origame[0].height * width) / 2 / imagem.origame[0].width + 70,
        50,
        0,
        "Pagina 1"
      ),
      pagDois: new GUI(
        ...
        width / 2,
        (imagem.origame[1].height * width) / 2 / imagem.origame[1].width + 70,
        50,
        1,
        "Pagina 2"
      ),
      pagTres: new GUI(
        ...
        width / 2,
        (imagem.origame[2].height * width) / 2 / imagem.origame[2].width + 70,
        50,
        2,
        "Pagina 3"
      ),
...
function draw() {
  switch (state) {
    ...
    case "LEITORQR":
      ...
      textSize(30);
      text("Senha Inserida:", 50, height / 2 - 50, width - 100);
      if (senha !== null) {
        fill(0);
        text(senha, 50, height / 2 + 50, width - 100);
      }
      textStyle(NORMAL);
      textSize(20);
      if (
      ...
      if (
        ...
        switch (fase) {
          ...
          case 1:
            ...
            break;
          case 2:
            if (senha == "Entre telas e pinceis") {
              state = "FASE_3";
              fase = 3;
            } else {
              senha = "Senha Incorreta";
